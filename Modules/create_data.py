...
val_img_path = r"../Datasets/Raw/val"
val_ann_path = r"../Datasets/Raw/val_labels"
val_cropped_img_dir = r"../Datasets/Processed/val_images"

crop_image(val_img_path, val_ann_path, val_cropped_img_dir, val_img_map, val_map_json)
create_data(r'../Datasets/Processed/val_ann_50.txt', val_img_map)

train_img_path = r"../Datasets/Raw/train"
train_ann_path = r"../Datasets/Raw/train_labels"
train_cropped_img_dir = r"../Datasets/Processed/train_images"

crop_image(train_img_path, train_ann_path, train_cropped_img_dir, train_img_map, train_map_json)
create_data(r'../Datasets/Processed/train_ann_50.txt', train_img_map)
